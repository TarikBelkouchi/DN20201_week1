...
namespace LoopDemo
{
    class MainClass
    {
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("Let's count down startign with 10 and ending with 1 (inclusive for both.)");
            for (int i = 10; i > 0; i--)
            {
                //int r = 5; Question: Does this go away? What is the scope? Play with it and find out
                Console.WriteLine(i);
                //Console.WriteLine(r);
            }
